...
CORE_SECTIONS = [
    {
        ...
        'survey_desc':   'GRI 1 Foundation — 8 criteria × 4 layers (Policy/Implementation/Measurement/Results) = 32 questions, 168 pts max. Topics: G1–G8 (board governance, leadership, remuneration, materiality, strategy, stakeholder engagement, freedom of association, anti-bribery).',
        'cat_name':      'Foundation',
        'cat_name_tr':   'Temel',
        'max_score':     168,
    ...
    },
    {
        ...
        'survey_name_tr':'GRI 2: Genel Açıklamalar',
        'survey_desc':   'GRI 2 General Disclosures — 20 criteria × 4 layers = 80 questions, 392 pts max. Topics: G9–G14 (grievance, assurance, reporting frameworks, supply chain, tax, EVG&D), E4 (climate risk/TCFD), E11 (supplier env.), S3–S5/S7/S9 (employment, wages, parental leave, board diversity, HRDD), EC1–EC7 (all economic topics).',
        'cat_name':      'General Disclosures',
        'cat_name_tr':   'Genel Açıklamalar',
        'max_score':     392,
        'env_w': 0.15, 'soc_w': 0.25, 'gov_w': 0.60,
    },
    {
        'sheet':         'GRI 3 — Material Topics',
        'survey_name':   'GRI 3: Material Topics',
        'survey_name_tr':'GRI 3: Önemli Konular',
        'survey_desc':   'GRI 3 Material Topics — 18 criteria × 4 layers = 72 questions, 344 pts max. Topics: E1–E3/E5–E10/E12 (GHG, net-zero, carbon price, energy, water, waste, biodiversity, air, deforestation), S1–S2/S6/S8/S10–S13 (OHS, L&D, DEI, child/forced labour, community, privacy, product safety).',
        'cat_name':      'Material Topics',
        'cat_name_tr':   'Önemli Konular',
        'max_score':     348,
        'env_w': 0.45, 'soc_w': 0.45, 'gov_w': 0.10,
    },
]
